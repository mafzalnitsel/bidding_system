      ...
      <div className="card">
        ...
        <ResponsiveContainer width="100%" height={300}>
          ...
          >
            ...
            <Tooltip />
            <Legend />
            <Bar dataKey="sales" fill="#c32127" name="Sales" />
            <Bar dataKey="profit" fill="#0b9fc8" name="Profit" />
            <Bar dataKey="revenue" fill="#268c11" name="Revenue" />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
