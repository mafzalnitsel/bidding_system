...
function Packages({ data }) {
  ...
  const submit = async () => {
    ...
    let body = {
      ...
      U_StandardHr: headerdata?.U_StandardHr,
      U_Type: type,
  ...
  const fetchAllData = async (cook) => {
    ...
    let SAPApi =
      type && type !== "-"
        ? `OMMP?$select=Code,U_Comments,U_DocTotal,U_Type,MMP1Collection,U_StandardHr&$filter=U_Type eq '${type}'`
        : `OMMP?$select=Code,U_Comments,U_DocTotal,U_Type,MMP1Collection,U_StandardHr`;
    await axios
      .post(API_TYPES.GET, {
        api: SAPApi,
        cookie: cook,
    ...
    <>
      ...
      <div className="main_container">
        <div className="left">
          ...
          {type === "CR" && <div className="header_items_container">
            <label>Standard Hours</label>
            <input
              type="number"
              value={headerdata?.U_StandardHr}
              onChange={(e) => getvaluefrominput(e)}
              className="input"
              name="U_StandardHr"
            />
        ...
        <div className="right">
          <div className="header_items_container">
            ...
            <Select
              ...
              value={typesoptions?.filter(
                (option) => option.value === (type || headerdata?.U_Type)
              )}
              name="Type"
              onChange={(e) => {
                settype(e.value);
                otherItems.includes(e.value)
                  ? otherPackages()
                  : mainPackages();
              }}
          ...
          <div className="header_items_container">
            ...
            <input
              ...
              type="input"
              className="input"
              value={doctotal || headerdata?.U_DocTotal}
            />
          </div>
        </div>
      </div>
                  ...
                  >
                    ...
                    <td>
                      <div className="inside_td">
                        {packagesList?.filter(
                          (list) =>
                            list.value == (item?.ItemCode || item.U_MTCode)
                        ).length === 0 && item.U_MTCode ? (
                          <>
                            <span>{item.U_MTCode}</span>
                          </>
                        ) : (
                          <>
                            <Select
                              ...
                              onChange={(e) => {
                                ...
                                lastpurchseprice(e.value, index);
                              }}
                              value={packagesList?.filter(
                                (list) =>
                                  list.value ===
                                  (item?.U_MTCode || item?.ItemCode)
                              )}
                      ...
                      <div className="inside_td">
                        {uomlist && (
                          <Select
                            ...
                            styles={TableCustomStyle}
                            onChange={(e) => {
                              ItemsDropDownfunc(e, index, "U_Unit");
                            }}
                            value={uomlist?.filter(
                              (option) =>
                                option.value === item?.U_Unit ||
                                option.label === item.U_Unit
                            )}
                            options={uomlist}
                            displayValue="name"
                          />
                    ...
                    <td>
                      <div className="inside_td">
                        <input
                          ...
                          // onChange={(e) => tablegetvaluefrominput(e, index)}
                          value={Number(
                            Number(item?.U_Quantity || 1) *
                            Number(item?.U_Rate) || 0
                          ).toFixed(2)}
                          name="Cost"
                          className="form-control"
                        />
          ...
          <Table striped bordered hover>
            <thead style={fixedtableheader}>
              <tr style={{ ...fixedtablerow, background: "#0b9fc8" }}>
                ...
                <th style={{ backgroundColor: "#0b9fc8", color: "white" }}>
                  {/* <div>Unit MHR</div> */}
                  {type === "CR" ? <div>Percentage</div> : <div>MC Hours</div>}
                </th>
                <th style={{ backgroundColor: "#0b9fc8", color: "white" }}>
                  {/* <div>Total MH</div> */}
                  {type === "CR" ? <div>Percentage Value</div> : <div>Rate</div>}
                </th>
                <th style={{ backgroundColor: "#0b9fc8", color: "white" }}>
                  {/* <div>UMH Rate</div> */}
                  <div>Cost</div>
                  ...
                  >
                    ...
                    <td>
                      <div className="inside_td">
                        {
                          uomlist?.find(
                            (option) => option.value === item?.U_Unit
                          )?.label
                        }
                      </div>
                    </td>
